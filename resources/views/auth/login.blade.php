    ...
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-6" method="POST" action="{{ route('login') }}" novalidate>
                    @csrf
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password" class="p-2 bg-gray-100 rounded form-input w-full @error('password') border border-red-500 @enderror" name="password" autocomplete="current-password">
