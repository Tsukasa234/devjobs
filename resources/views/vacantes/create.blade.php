...
<form action="{{route('vacantes.store')}}" method="POST" class="max-w-lg mx-auto my-10">
    ...
    <div class="mb-5">
        ...
        <input placeholder="Titulo de la vacante" id="titulo" value="{{old('titulo')}}" type="text" class="p-2 bg-gray-100 rounded form-input w-full @error('titulo') border border-red-500 @enderror" novalidate name="titulo">
    ...
    <button type="submit" class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100 font-bold p-3 focus:outline focus:shadow-outline uppercase">Crear Vacante</button>
