...
@section('content')
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500">
                                <a href="{{route('candidatos.index', ['id' => $vacante->id])}}" class="text-gray-500 hover:text-gray-600">{{$vacante->candidato->count()}} Candidatos</a>
                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 font-medium">
                                <a href="{{route('vacantes.show',['vacante' => $vacante->id])}}" class="text-teal-600 hover:text-teal-900 mr-5">Ver</a>
    ...
    {{$vacantes->links()}}
    @else
    <p class="text-center mt-10 text-gray-700">No tienes vacantes, Crea algunas</p>
